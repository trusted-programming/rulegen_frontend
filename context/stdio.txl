...
%primitiveTypes.txl end Wain

%usleep.txl start Wain
...
%cleanOuterAttributes start Wain
...
%cleanOuterAttributes end Wain

%rmUnstableInnerAttributes start Wain
...
%rmUnstableInnerAttributes end Wain

%cleanExternCBlock start Wain
...
%cleanExternCBlock end Wain

%rmUseScrust start Wain
